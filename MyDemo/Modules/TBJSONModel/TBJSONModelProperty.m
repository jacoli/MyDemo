...
@implementation TBJSONModelProperty
...
+ (instancetype)propertyWithName:(NSString *)name typeString:(NSString *)typeString{
    TBJSONModelProperty *property = [self new];
    property->_name = name;
    ...
    if ([typeStringComponents count] > 0) {
        ...
        if ([typeInfo length] > scanLocation) {
            ...
            property->_valueType = (TBJSONModelPropertyValueType)[indexNumber integerValue];
